...
public class JCPApplet extends JChemPaintPanel {
    ...
    public static void main(String[] args) {
       ...
       JCPApplet jcpPanel = new JCPApplet();
    ...
    public JCPApplet() {
       ...
       super(emptyModel(), GUI_APPLICATION, debug, null, new ArrayList<String>());
        //this.setShowInsertTextField(false);
        //this.setShowMenuBar(false);
        //this.setShowToolBar(false);
        //this.setShowStatusBar(false);
        //this.setModified(false);
        workPath = System.getProperty("user.dir") + "\\files";
        File file = new File(workPath);
        this.setCurrentWorkDirectory(file);
    }
