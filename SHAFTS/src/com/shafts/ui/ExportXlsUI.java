...
public class ExportXlsUI extends javax.swing.JDialog {
     ...
     * @param table
     */
    public ExportXlsUI( JTable table) {
        this.table = table;
	...
	if (i == 0 || i > j) {
				...
				"The start number can't be 0 ！","Tips",JOptionPane.INFORMATION_MESSAGE);
                        else
                                JOptionPane.showMessageDialog(null,"Input illegal! The start number should be smaller than the end number!","Tips",JOptionPane.INFORMATION_MESSAGE);
                	} else {
                                exportXls(table, i, j);
               }
            }
...
protected void exportXls(JTable table, int i, int j) {
	...
	if (table.getRowCount() == 1 || temp.equals(""))
		JOptionPane.showMessageDialog(null,
				"There is no any data in the form！","Tips",JOptionPane.INFORMATION_MESSAGE);
	else {
	...
	try {
		...
		i++;
			...
			t.printStackTrace();
			JOptionPane.showMessageDialog(null, "Failed！","Tips",JOptionPane.ERROR_MESSAGE);
                                                     dispose();
		}
	if (ExportFlag){
		JOptionPane.showMessageDialog(null, "Export Success！","Tips",JOptionPane.INFORMATION_MESSAGE);
                                   dispose();
                        }
        }
}
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                ExportXlsUI dialog = new ExportXlsUI(table);
