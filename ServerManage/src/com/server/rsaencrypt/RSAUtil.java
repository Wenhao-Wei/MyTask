 ...
 */
package com.server.rsaencrypt;

/**
 *
 * @author Little-Kitty
 * @date 2014-9-14 13:24:39
 */
 ...
 * 文件名：RSAUtil.java<br> @author 董利伟<br> 版本:
 * <br> 描述：
 * <br> 创建时间:2008-9-23 下午09:58:16
 * <br> 文件描述：
 * <br> 修改者：
 * <br> 修改日期：
 * <br> 修改描述：
...
public class RSAUtil {
    ...
    private String filePath = "E:\\Master\\MyOffice\\UserCrack\\";
    /**
     * 初始化密钥对
     */
    public RSAUtil() {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String str = "23154541245812315454";
        RSAPublicKey pubKey = rsa.getRSAPublicKey();
        RSAPrivateKey priKey = rsa.getRSAPrivateKey();
        byte[] key = priKey.getEncoded();
        String sKey = toHexString(key);
        String s = toHexString(rsa.encrypt(pubKey, str.getBytes()));
        System.out.println("加密后==" + s);
        File file = new File("shafts.pem");
        if(file.exists())
            file.delete();
        FileWriter fw = new FileWriter("shafts.pem", true);
        BufferedWriter bw = new BufferedWriter(fw);
        bw.write("<@Pipespace@>");
        bw.newLine();
        bw.write(sKey);
        ...
        bw.close();
        fw.close();
        //System.out.println("解密后==" + new String(rsa.decrypt(priKey, s.getBytes())));
    }
}
